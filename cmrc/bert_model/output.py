...
def write_predictions(bert_vocab_file,all_examples, all_features, all_results, n_best_size,
    ...
    for (example_index, example) in enumerate(tqdm(all_examples)):
        ...
        for pred in prelim_predictions:
            ...
            if pred.start_index > 0:  # this is a non-null prediction
                ...
                final_text = get_final_text(bert_vocab_file,tok_text, orig_text, do_lower_case)
                if final_text in seen_predictions:
                    continue
...
def get_final_text(bert_vocab_file,pred_text, orig_text, do_lower_case, verbose_logging=False):
    ...
    tokenizer=BertTokenizer.from_pretrained(vocab_file=bert_vocab_file)
